...
import com.zhy.http.okhttp.https.HttpHeaders;
    ...
    public interface Logger {
        ...
        LoggingInterceptor.Logger DEFAULT = new LoggingInterceptor.Logger() {
            ...
            public void log(String message) {
                java.util.logging.Logger logger = java.util.logging.Logger.getLogger(LoggingInterceptor.class.getName
                        ());
                Throwable t = null;
